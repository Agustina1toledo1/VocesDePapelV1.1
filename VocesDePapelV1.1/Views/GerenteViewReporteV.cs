...
{
    public partial class GerenteViewReporteV : Form, IGerenteViewReporteV
    {
        ...
        private static GerenteViewReporteV instance;
        public static GerenteViewReporteV GetInstance(Form parentConteiner)
        {
            if (instance == null || instance.IsDisposed) //si es nulo o esta desechado
            {
                instance = new GerenteViewReporteV();
